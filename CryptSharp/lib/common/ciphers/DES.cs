namespace CryptSharp.lib.common.ciphers {
    /// <summary>
    /// Interface working with DES CryptoServiceProvider class.
    /// </summary>
    public class DES {
        /// <summary>
        /// Specified CryptoServiceProvider.
        /// </summary>
        private System.Security.Cryptography.DESCryptoServiceProvider csp;
        ...
        /// <returns>CSP</returns>
        private System.Security.Cryptography.DESCryptoServiceProvider createCSP(System.Security.Cryptography.Rfc2898DeriveBytes inPBKDF2) {
            inPBKDF2.Reset();
            csp = new System.Security.Cryptography.DESCryptoServiceProvider();
